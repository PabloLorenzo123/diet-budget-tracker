    ...
    return (
        ...
        <div id="content">
            <div id="form" className="mx-auto p-5 border border-2 shadow" style={{maxWidth: '500px'}}>
                <h2 className="font-weight-bold text-center mb-3">Create Your Free Account</h2>
                <form onSubmit={handleSubmit} method="POST">
                    ...
                    <button className="btn d-block btn-primary mx-auto" style={{width: "80%"}} type="submit">SIGN UP</button>
                </form>
            </div>
        </div>
        </>
